              ...
              <div key={filter.name} className="space-y-1.5">
                ...
                {filter.type === "select" ? (
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger
                        className="h-10 bg-background/50 border-border/60 hover:border-border transition-colors shadow-none focus:ring-1 focus:ring-primary/30"
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-10 pl-8 pr-8 bg-background/50 border-border/60 hover:border-border transition-colors shadow-none focus-visible:ring-1 focus-visible:ring-primary/30"
        ...
        <div className="flex flex-wrap items-center gap-2 mt-1 animate-fade-in">
          ...
          {activeFilters.map(([key, val]) => (
            <Badge
              ...
              onClick={() => {
                const type = filters.find((f) => f.name === key)?.type;
                onChange(key, type === "select" ? "all" : "");
              }}
            >
              <span className="opacity-70">{getFilterConfigLabel(key)}:</span>{" "}
